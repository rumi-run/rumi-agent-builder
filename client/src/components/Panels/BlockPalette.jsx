...
export default function BlockPalette() {
    ...
    return (
      <div className="w-12 bg-rumi-shell border-r border-rumi-border flex flex-col items-center py-3">
        <button
          ...
          className="w-10 h-10 sm:w-8 sm:h-8 rounded-lg bg-rumi-sidebar hover:bg-rumi-border flex items-center justify-center text-gray-400 hover:text-white transition-colors"
  ...
  return (
    <div className="w-52 sm:w-60 md:w-64 bg-rumi-shell border-r border-rumi-border flex flex-col shrink-0 min-w-0">
      {/* Header */}
      <div className="flex items-center justify-between px-4 py-3 border-b border-rumi-border">
        ...
        <button
          ...
          className="min-h-9 min-w-9 sm:min-h-0 sm:min-w-0 sm:w-6 sm:h-6 rounded flex items-center justify-center text-gray-500 hover:text-white hover:bg-white/5 transition-colors"
